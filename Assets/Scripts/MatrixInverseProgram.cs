...
using UnityEngine;
  class MatrixInverseProgram : MonoBehaviour
  {
     ...
     int MatrixDecompose(double[][] m, out double[][] lum, out int[] perm)
    {
     ...
     double[] Helper(double[][] luMatrix, double[] b) // helper
    {
     ...
     double[][] MatrixCreate(int rows, int cols)
    {
     ...
     double[][] MatrixProduct(double[][] matrixA,
      double[][] matrixB)
    {
     ...
     string MatrixAsString(double[][] matrix)
    {
      string s = "";
